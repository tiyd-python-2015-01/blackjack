...
icons = ["\033[.31m♡\033[.37m", "♧", "\033[.31m♢\033[.37m", "♤"]
...
class Interface:
    ...
    * Control game flow
    ...
    def main_menu(self):
        ...
        title_text = (
            ".------..------..------..------..------..------..------..------."
            ".------.\n|B.--. ||L.--. ||\033[.31mA\033[.37m.--. ||\033[.31mC"
            "\033[.37m.--. ||\033[.31mK\033[.37m.--. ||J.--. ||\033[.31mA"
        ...
        print(info)
        print("Main Menu:")
        print("\033[.31m♡\033[.37m 1 - New Game")
        print("♤ 2 - Continue Game")
        print("\033[.31m♢\033[.37m 3 - Set Game Options")
        print("♧ 4 - Quit")
        print("-----------------------")
